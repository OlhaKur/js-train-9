...
function findIndexByProperty(arr, name) {
  ...
  const userName = (element) => (element = name);
  console.log(arr.findIndex(userName));
...
function findLastEvenNumber(arr) {
  ...
  const found = (element) => element % 2 === 0;
  console.log(arr.findLast(found));
...
function getSubArrayAndConvertToString(arr, startIdx) {
  ...
  console.log(arr.slice(startIdx).join(" "));
  // Перевіряємо, чи вхідний параметр є масивом, якщо ні повертаємо 'Вхідний параметр має бути масивом'
...
function removeAndDouble(arr, startIdx) {
  ...
  console.log(arr.splice(startIdx).map((x) => x * 2));
...
function flattenSquareAndFilter(arr, threshold) {
  ...
  console.log(arr.flat(threshold));
  console.log(arr.map((x) => x ** 2));
  console.log(arr.filter((element) => element > threshold));
...
function getLastElementsSumAndPrint(arr, n) {
  ...
  const result = arr.reduceRight((accumulator, n) => accumulator + n);
...
function wordLengths(arr) {
  ...
  console.log(arr.map((lengthsArray) => lengthsArray.length));
  // Перевіряємо, чи вхідний параметр є масивом, якщо ні, повертаємо 'Вхідний параметр має бути масивом'
...
function insertElementAt(arr, index, element) {
  ...
  console.log(arr.splice(index, 0, element));
  // Перевіряємо, чи вхідний параметр є масивом, якщо ні повертаємо 'Вхідний параметр має бути масивом'
...
function expandArrayByN(arr, n) {
  ...
  return arr.flatMap(function (number) {
    return Array(n).fill(number);
  });
}
...
function findDuplicateElements(arr) {
  ...
  let duplicates = arr.filter(function (element, index) {
    // Перевіряємо, чи елемент дублюється в масиві
...
function capitalizeWords(arr) {
  ...
  let capitalizedWords = arr.map(function (word) {
    let firstLetter = word.charAt(0).toUpperCase();
    let restOfWord = word.slice(1).toLowerCase();
    return firstLetter + restOfWord;
  });

  // Повертаємо речення з перетвореними словами
...
function calculateTotalPrice(arr) {
  ...
  // Перебираємо об'єкти товарів в масиві
  for (let i = 0; i < arr.length; i++) {
    let product = arr[i];
...
function findLastNegativeNumberIndex(arr) {
  ...
  // Використовуємо метод findLastIndex() для знаходження індексу останнього від'ємного числа
  let lastIndex = arr.findLastIndex(function (number) {
    return number < 0;
  });
